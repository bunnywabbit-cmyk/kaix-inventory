...
function Header({
  ...
  return (
    <header className="sticky top-0 z-20 shrink-0 border-b border-slate-200 bg-white/95 pt-[env(safe-area-inset-top)] backdrop-blur supports-backdrop-filter:bg-white/80 dark:border-slate-800 dark:bg-slate-950/95 dark:supports-backdrop-filter:bg-slate-950/80">
